    ...
    <div style="grid-column:1/-1;background:var(--bg2);border:1px solid var(--bd2);border-radius:10px;padding:16px">
      ...
      <div style="display:flex;gap:28px">
        <div style="flex:1;min-width:0">
          ...
          <div id="taftat-dist-leg" style="display:flex;flex-direction:column;gap:6px;margin-top:3px"></div>
        </div>
        <div style="flex:1;min-width:0">
          ...
          <div id="taftat-cia-leg" style="display:flex;flex-direction:column;gap:6px;margin-top:3px"></div>
        </div>
      </div>
    </div>`;
