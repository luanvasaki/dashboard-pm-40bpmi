        ...
        legend: {
          ...
          labels: {
            ...
            generateLabels: () => [
              ...
              { text: 'Acima da meta, melhorando', fillStyle: 'rgba(191,122,61,.85)',  strokeStyle: 'transparent', lineWidth: 0, fontColor: '#e0ecf8', color: '#e0ecf8' },
              { text: 'Acima da meta, piorando',   fillStyle: 'rgba(200,75,75,.80)',   strokeStyle: 'transparent', lineWidth: 0, fontColor: '#e0ecf8', color: '#e0ecf8' },
